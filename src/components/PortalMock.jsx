      ...
      <footer className="portal-footer">
        <div className="portal-footer-content">
          <div className="footer-partners">
            <span className="partners-label">Realização & Parceria</span>
            <div className="partners-logos">
              <span className="portal-logo-footer">DIVERSA</span>
              <span className="logo-divider">|</span>
              <div className="accenture-footer-logo">
                <svg viewBox="0 0 153 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <title>Accenture</title>
                  <path
                    className="cmp-logo__greater-than"
